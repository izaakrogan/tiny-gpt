...
What you implement here is the attention material from the course: QKV
projections, scaled scores, the causal mask, softmax, weighted sum.
...
class CausalSelfAttentionHead(nn.Module):
    def __init__(self, n_embd: int, head_size: int, block_size: int):
        super().__init__()
        # The three projections from the Transformers I module. bias=False because nothing
    ...
    def forward(self, x):
        ...
        # TODO 1: project x into Query, Key, Value.         (Transformers I)
        #   q, k and v are each (B, T, head_size).
        q = ...
        k = ...
        v = ...

        # TODO 2: raw relevance scores, scaled.             (Transformers I)
        ...
        # TODO 3: the causal mask.                          (new here)
        ...
        # TODO 4: softmax the scores into attention weights. (Transformers II)
        #   weights is (B, T, T), each row positive and summing to 1.
        weights = ...

        # TODO 5: weighted sum of the Values.               (Transformers I)
